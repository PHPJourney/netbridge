...
const dict = {
  zh: {
    ...
    "dl.windows2012Banner": "Server 2012 / 2012 R2：不要下上方 Setup，也不要下「客户端」里的网桥 VPN Setup。请直接看下方高级区三步。",
    "dl.windowsAdvanced": "高级 · Server 2012 / 无 GUI（必看）",
    "dl.windows2012Lead": "Server 2012 / 2012 R2 正确安装（勿用任何 Setup）：",
    "dl.windows2012Step1": "下载 nbvpn-windows-amd64-win2012.exe",
    "dl.windows2012Step2Tail": "放到同一文件夹",
    "dl.windows2012Step3": "管理员 PowerShell 执行下方命令",
    ...
    "dl.windowsSameFolder": "2012：将 install.ps1 与 nbvpn-windows-amd64-win2012.exe 放同一文件夹；勿用 nbvpn-windows-amd64.exe / 任意 Setup / GUI / 客户端安装包。",
    "dl.windowsSetupPrimary": "Win10+/2016+：Setup.exe。2012：仅 win2012 exe + install.ps1（-SkipWireGuard）。",
  ...
  en: {
    ...
    "dl.windows2012Banner": "Server 2012 / 2012 R2: do not download Setup above, and do not use the client “网桥 VPN” Setup. Follow the three steps in Advanced below.",
    "dl.windowsAdvanced": "Advanced · Server 2012 / headless (required)",
    "dl.windows2012Lead": "Server 2012 / 2012 R2 correct install (no Setup packages):",
    "dl.windows2012Step1": "Download nbvpn-windows-amd64-win2012.exe",
    "dl.windows2012Step2Tail": "into the same folder",
    "dl.windows2012Step3": "Run the command below in elevated PowerShell",
    "dl.windows2012Cmd": "powershell -ExecutionPolicy Bypass -File .\\install.ps1 -SkipWireGuard",
    "dl.windowsBootstrapHint": "PowerShell one-liner (elevated; detects 2012 vs newer):",
    "dl.windowsSameFolder": "On 2012: put install.ps1 with nbvpn-windows-amd64-win2012.exe only — not modern exe / any Setup / GUI / client installer.",
    "dl.windowsSetupPrimary": "Win10+/2016+: Setup.exe. 2012: win2012 exe + install.ps1 (-SkipWireGuard) only.",
