...
const dict = {
  zh: {
    ...
    "clients.title": "下载客户端",
    "clients.lead": "Windows、macOS、Android、iOS。版本与 SHA256 来自发布清单。",
    "servers.title": "部署服务端",
    "servers.lead":
    ...
    "help.install.winBody":
      "已提供 <code>nbvpn-windows-amd64.exe</code> 与 <code>server/install/windows/install.ps1</code>。请先安装 <a href=\"https://www.wireguard.com/install/\" rel=\"noopener noreferrer\">WireGuard for Windows</a>。客户端出网 NAT 依赖 <code>New-NetNat</code> / RRAS，详见仓库 <code>WINDOWS.md</code>；与 Linux iptables 完整对等仍可能需额外配置。",
  ...
  en: {
    ...
    "clients.lead": "Windows, macOS, Android, and iOS. Versions and SHA256 come from the release manifest.",
    ...
    "help.install.winBody":
      "Ships <code>nbvpn-windows-amd64.exe</code> and <code>server/install/windows/install.ps1</code>. Install <a href=\"https://www.wireguard.com/install/\" rel=\"noopener noreferrer\">WireGuard for Windows</a> first. Client egress NAT depends on <code>New-NetNat</code> / RRAS — see <code>WINDOWS.md</code> in the repo; full parity with Linux iptables may need extra setup.",
